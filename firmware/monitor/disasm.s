...
AROUND:
  ...
  LDX #3
  JSR print_spaces       ; then three spaces
  LDA OPCODE            ; get instruction op code
  JSR print_hex         ; display the opcode byte
  JSR PrintSpace
...
@ADD:
  ...
  ADC #0                ; add any carry
  STA DEST+1
  JSR print_hex         ; display high byte
  LDA DEST
  JSR print_hex         ; display low byte
  JMP DONEOPS
TRYIMP:
  LDA AM
  CMP #AM_IMPLICIT
